# Termos e Condições de Uso - NEØ.FLOWOFF
...
- **Serviço**: Refere-se ao ecossistema NEØ.FLOWOFF, incluindo mas não limitado a:
  - Plataforma PWA (Progressive Web App)
  - Token $NEOFLW e funcionalidades relacionadas
  - Serviços de desenvolvimento (Sites/WebApps, SAAS/BAAS)
  - Serviços de tokenização
  - POSTØN e PRO.IA
  - Qualquer outro serviço oferecido pela NEØ.FLOWOFF

- **Usuário**: Qualquer pessoa que acesse ou use nossos serviços
- **Wallet**: Carteira digital utilizada para interagir com o token $NEOFLW na Base Network
...
- Você é responsável por manter a segurança de sua wallet e credenciais
- Você é responsável por todas as atividades que ocorrem sob sua wallet
- A NEØ.FLOWOFF não armazena suas chaves privadas
...
- Tentar obter acesso não autorizado ao serviço ou sistemas relacionados
- Interferir ou interromper o serviço ou servidores conectados ao serviço
- Usar o serviço para qualquer atividade que possa prejudicar ou explorar menores

## 4. Token $NEOFLW

### 4.1 Natureza do Token

- O token $NEOFLW é um token de infraestrutura na Base Network
- O token não é um título de investimento ou ativo especulativo
- O token aparece como consequência do uso do sistema
- O token não garante retornos financeiros
...
- Não há garantias sobre o valor futuro do token
- Você é o único responsável por suas decisões de investimento

### 4.3 Responsabilidade

- A NEØ.FLOWOFF não é responsável por perdas financeiras relacionadas ao token
- Você é responsável por entender os riscos antes de usar o token
- Recomendamos consultar um consultor financeiro antes de tomar decisões
...
- Não violação
- Precisão, confiabilidade ou disponibilidade do serviço
...
- Resultantes de transações blockchain ou uso de tokens
...
Estes Termos constituem o acordo completo entre você e a NEØ.FLOWOFF em relação ao uso do serviço.

## 14. Contato

Para questões sobre estes Termos, entre em contato:

- **Email**: contato@flowoff.com.br
- **Website**: https://flowoff.com.br
